...
function Support() {
  ...
  tabTitle('Support | FareCompare India')
  ...
  const copyWebLink = () => {
    navigator.clipboard.writeText('https://FareCompareindia.netlify.app')
        ...
        <div className='cloud-bg' style={{borderRadius:'0.4em', paddingInline:'10%', paddingBlock:'5%'}}>
          <div style={{backgroundColor:'var(--text)', borderRadius: '0.2em', color:'var(--dark)', paddingInline:'5%', paddingBlock:'5%'}}>
            <div style={{textAlign:'center',marginTop:'2%'}}>
              ...
              <Button onClick={() => {openInNewTab('https://github.com/ManavMehta-Official/FareCompare')}} className='indigo-btn-outline' fullWidth sx={{mt:5}}>Contribute to Repository</Button>
