    ...
    <AppBar position="static" sx={{ backgroundColor: "var(--dark)", boxShadow: "none" }}>
      <Container maxWidth="xl">
        <Toolbar disableGutters>
          <img src={logo} style={{ width: '2%' }} className="xs-none md-flex" alt="FareCompare India Logo" />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <img src={logo} alt="FareCompare India logo" className='xs-flex md-none' style={{ width: '6%' }} />
          <Typography
            variant="h6"
            noWrap
            component="a"
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'center', alignItems: 'center' }}>
            {pages.map((page) => (
              <Button
                ...
                onClick={() => {
                  if (page === 'github') {
                    window.location.href=`https://github.com/ManavMehta-Official/FareCompare`
                  } else {
